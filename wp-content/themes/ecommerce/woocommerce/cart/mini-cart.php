...
<?php if ( ! WC()->cart->is_empty() ) : ?>
    ...
    <ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?> b-mini_cart_items mb-0 list-unstyled">
		<?php
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				?>
                <li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?> clearfix">
					<?php
					...
					$image = getResizedImage( $image, [ 50, 50 ] );
    ...
    <div class="woocommerce-mini-cart__buttons buttons pl-3 pr-3">
		...
		?>
        <a href="<?= wc_get_cart_url() ?>" class="btn d-block mb-2">Cart</a>
