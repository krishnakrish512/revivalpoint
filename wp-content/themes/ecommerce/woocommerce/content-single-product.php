                    ...
                    <div class="b-product_single_summary summary entry-summary">
                        ...
                        <div class="b-product_single_order-by">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="tel:<?= $contact['phone_number'] ?>" class="phone" title="order by phone"
                                       rel="tooltip">
                                        <i class="ico-phone"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://wa.me/<?= $whatsapp_number ?>" class="WhatsApp" target="_blank"
                                       title="order by phone">
                                        <i class="ico-whatsapp"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="viber://chat?number=%2B<?= $viber_number ?>" class="viber"
                                       target="_blank" title="order by phone">
                                        <i class="ico-viber"></i>
                                    </a>
                                </li>
                            </ul>
